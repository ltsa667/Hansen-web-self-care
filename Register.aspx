    ...
    <div class="col span_2_of_3">
        ...
        <!-- fieldsets --> 
            ...
            <fieldset runat="server">
                ...
                <ContentTemplate>
                    <div class="firststep"> 
                        <asp:PlaceHolder ID="select_package" runat="server">
          ...
          <asp:DropDownList ID="SelectPackage" runat="server" OnSelectedIndexChanged="DropDownList2_SelectedIndexChanged" AutoPostBack="True">
                        <asp:ListItem Text ="TV Standard/$59.99" Value ="2" />
                        <asp:ListItem Text="TV Basic/$39.99" Value ="1"/>
                        <asp:ListItem Text ="TV Premium/$79.99" Value ="3" />
                            <asp:ListItem Text ="Internet Subscription/$99.99" Value ="4" />
                            <asp:ListItem Text ="Buy one movie/ $9.99" Value ="5" />
                            <asp:ListItem Text ="Buy an extra channel/$19.99" Value ="6" />
                        </asp:DropDownList>
                       ...
                       <asp:Image ID="PackageImage" runat="server" width="50%" height="20%" ImageUrl ="~/Pictures/paytv2.jpg"/>
                        ...
                        &nbsp;&nbsp;<br />
                        <hr/>
                        <asp:PlaceHolder ID="select_device" runat="server">
...
chosen. If you already have the devices, please tick off the box."></asp:Label>  
                        ...
                        <asp:PlaceHolder ID="contract_length" runat="server">
                        ...
                        <asp:PlaceHolder ID="package_start_date" runat="server">
                    <asp:Label ID="PackageStartLabel" runat="server" Text="Package Start Date: *"></asp:Label>
                        ...
                        <hr />
                        <asp:PlaceHolder ID="total_amount" runat="server">
              ...
              <fieldset runat="server">
                ...
                <div class="secondstep">
                    ...
                    <asp:PlaceHolder ID="login_details" runat="server">
                    ...
                    <asp:PlaceHolder ID="date_of_birth" runat="server">
                    ...
                    <asp:PlaceHolder ID="billing_address" runat="server">
                ...
                <hr />
                    ...
                    <asp:PlaceHolder ID="phone_number" runat="server">
                ...
                <fieldset runat="server">
                    ...
                    <ContentTemplate>
                    <div class="thirdstep"> 
                        <asp:PlaceHolder ID="payment_tyoe" runat="server">
                        ...
                        <asp:PlaceHolder ID="card_no" runat="server">
                        ...
                        <asp:PlaceHolder ID="secure_code" runat="server">
                        <asp:Label ID="SecureCodeLabel" runat="server" Text="Security Code: *" Visible="False"></asp:Label>
                        &nbsp;
                            
                            <asp:PlaceHolder ID="secure_code_image" runat="server" Visible="False">
                        ...
                        <asp:PlaceHolder ID="card_name" runat="server">
                        ...
                        <asp:PlaceHolder ID="card_expiry_date" runat="server">
