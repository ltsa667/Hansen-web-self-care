<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Test.aspx.cs" Inherits="PayTVWebSelfCare.Views.Test" %>
...
chosen. If you already have the devices, please tick off the box."></asp:Label>  
              ...
              <fieldset runat="server">
                ...
                <div class="secondstep">
                    ...
                    &nbsp;
                    <asp:TextBox runat="server" BorderColor="Black" ForeColor="#4968BE" Width="160px" Height="20px" ID="FirstNameTxt"></asp:TextBox>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:Label ID="LastNameLabel" runat="server" Text="Last Name: *"></asp:Label>
                    &nbsp;<asp:TextBox runat="server" BorderColor="Black" ForeColor="#4968BE" Width="160px" Height="20px" ID="LastNameTxt"></asp:TextBox>
                    &nbsp;<hr />
                    <asp:Label ID="EmailLabel" runat="server" Text="Email: *"></asp:Label>
                    &nbsp;<asp:TextBox ID="EmailTxt" runat="server" AutoPostBack="True" BorderColor="Black" ForeColor="#4968BE" OnTextChanged="TextBox1_TextChanged" TextMode="Email" Width="250px" Height="20px" placeholder="Example: test@gmail.com"></asp:TextBox>
                     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:Label ID="EmailConfrimLabel" runat="server" Text="Confirm Email: *"></asp:Label>
                    &nbsp;<asp:TextBox ID="EmailConfirmTxt" runat="server" AutoPostBack="True" BorderColor="Black" ForeColor="#4968BE" TextMode="Email" Width="250px" Height="20px" OnTextChanged="EmailConfirmTxt_TextChanged"></asp:TextBox>
                    ...
                    <asp:Label ID="BillingAddressLabel" runat="server" Text="Service Address: *"></asp:Label>
                     ...
                     &nbsp;&nbsp;<asp:TextBox ID="BillingStreetTxt1" runat="server" BorderColor="Black" Height="20px" Width="125px"></asp:TextBox>
                    &nbsp;<asp:Label ID="Label1" runat="server" Text="Street: "></asp:Label>
                     <asp:TextBox ID="BillingStreetTxt2" runat="server" BorderColor="Black" Height="20px" Width="180px"></asp:TextBox>
                     &nbsp;<asp:Label ID="BillingSuburbLabel" runat="server" Text="Suburb: "></asp:Label>
                    <asp:TextBox ID="BillingSuburbTxt" runat="server" BorderColor="Black" Height="20px" Width="180px"></asp:TextBox>
                    <br />
                    ...
                    &nbsp;<asp:TextBox ID="BillingZipTxt" runat="server" BorderColor="Black" Height="20px" Width="180px"></asp:TextBox>
                    <br />
                <hr />
