...
namespace PayTVWebSelfCare.Views
{
    public partial class Test : System.Web.UI.Page
    {
        ...
        protected string userLegalName;
        protected string userBillingAddress;
        protected string userServiceAddress;
        protected string userPreferPayType;
        protected string userCardNumber;
        protected string userSecurityCode;
        protected string userCardExpireDate;
        protected string userCardName;
        protected string userPackage;
        protected string userDevices;
        protected string userContractLength;
        protected double userTotalAmount;
        protected bool isValidPassword = false;
        protected bool isValidEmail = false;
        protected bool isValidPhone1 = false;
        protected bool isValidPhone2 = false;
        protected bool isValidPhone3 = false;
        protected bool isValidCardNum1 = false;
        protected bool isValidCardNum2 = false;
        protected bool isValidCardNum3 = false;
        protected bool isValidCardNum4 = false;
        protected bool isValidSecurityCode = false;
